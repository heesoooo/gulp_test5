	...
	for (let index = 0; index < children.length; index++) {
		...
		if (element.type === 'directory') {
			...
			if(element.extension == '.html') {
				li += '<li class="html"><a href="'+ element.path +'" class="item">'+ element.name +'</a>';
			} else if(element.extension == '.css') {
				li += '<li class="css"><a href="'+ element.path +'" class="item">'+ element.name +'</a>';
			} else if(element.extension == '.js') {
				li += '<li class="js"><a href="'+ element.path +'" class="item">'+ element.name +'</a>';
			}
		}
		if (element.children) {
			li += '<ul>';
